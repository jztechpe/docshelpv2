  ...
  <home-layout>
    <div :class="{ 'landing-page': true, 'show-mobile-menu': showMobileMenu }">
      <div class="mobile-menu" @click="$event.stopPropagation()">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a @click="scrollTo('#features')" href="javascript:;">INICIO</a>
          </li>
          <li class="nav-item">
            ...
            <div class="container">
              <div class="row home-row" id="homeRow">
                ...
                <div class="col-12 col-xl-4 col-lg-5 col-md-6">
                  <div class="home-text">
                    <div class="display-1">SITE CENTRAL</div>
                    <p class="white mb-5">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Blanditiis illum architecto, ullam, quo ipsa saepe
                      molestiae soluta totam ea eius temporibus odio hic in
                    </p>
                    <a
              ...
              <div class="row">
                <a
                  class="
                    btn btn-circle btn-outline-semi-light
                    hero-circle-button
                  "
            ...
            <div class="container copyright pt-5 pb-5">
              <div class="row">
                ...
                <div class="col-12 text-center">
                  <p class="mb-0">2022 © SiteCentral</p>
                </div>
              </div>
            </div>
          </div>
